...
# Load data
print("\n[1/5] Loading data...")
df = pd.read_csv(r'Sunchronizer\docu\measurements\02.03.2026_verlauf_incl_yield_today_and_outside_temp.csv')
...
plt.tight_layout()
plt.savefig(r'Sunchronizer\docu\measurements\graph_1_power_profile.png', 
...
plt.xticks(rotation=45)
plt.tight_layout()
plt.savefig(r'Sunchronizer\docu\measurements\graph_2_cumulative_yield.png', 
           dpi=150, bbox_inches='tight')
plt.close()
...
plt.tight_layout()
plt.savefig(r'Sunchronizer\docu\measurements\graph_3_comparison_bars.png', 
           dpi=150, bbox_inches='tight')
plt.close()
...
plt.tight_layout()
plt.savefig(r'Sunchronizer\docu\measurements\graph_4_advantage_analysis.png', 
           dpi=150, bbox_inches='tight')
plt.close()
...
plt.xticks(rotation=45)
plt.tight_layout()
plt.savefig(r'Sunchronizer\docu\measurements\graph_5_performance_area.png', 
           dpi=150, bbox_inches='tight')
plt.close()
...
if 'temperature' in channels:
    ...
    if len(graph_temp_data) > 0:
        ...
        plt.xticks(rotation=45)
        plt.tight_layout()
        plt.savefig(r'Sunchronizer\docu\measurements\graph_6_temperature_progression.png',
                   dpi=150, bbox_inches='tight')
        plt.close()
else:
...
**For a 10 kW Installation (25 panels × 400W):**

With this measured daily advantage of **278 Wh per panel**:
- **Daily additional yield (2-Axis vs. 1-Axis):** 278 × 25 = **6.95 kWh/day**
- **Annual additional yield (250 work days):** 6.95 × 250 = **1,738 kWh/year**
- **At €0.25/kWh:** **€434.50 additional revenue/year**
- **ROI for tracking mechanism:** ~3-5 years for typical systems
...
# Save report
with open(r'Sunchronizer\docu\measurements\ANALYSIS_REPORT_2026-03-02.md', 'w', encoding='utf-8') as f:
    f.write(report)
