...
**Recording Duration:** 15.1 hours (05:40 UTC to 17:42 UTC)  
**Outside Temperature:** 4.3°C to 17.0°C (Average: 11.4°C)

---

### Tracking Overview (Testbench Setup)

<a href="../../../pictures/testbench/sunchronizer_testbench_%283%29.jpg"><img src="../../../pictures/testbench/sunchronizer_testbench_%283%29.jpg" alt="Sunchronizer testbench setup" width="40%" /></a>
...
|---------|--------|-------|------------|------------|---------------------|---------------------|----------------------------------|
| **CH1** | West 30° (Static) | CHSM54M-HC-405 | 1116 | 1.12 | -53.4% | +23.6% | -44.7% |
| **CH2** | Sunchronizer S2 (1-Axis) | CHSM54M-HC-405 | 2136 | 2.14 | -10.8% | +136.5% | +5.8% |
| **CH3** | East 30° (Static) | JAM54S31-395 | 903 | 0.90 | -62.3% | Reference | -55.3% |
| **CH4** | Sunchronizer D2 (2-Axis) | JAM54S31-395 | **2394** | **2.39** | **Reference** | **+165.1%** | **+18.6%** |
| **CH1+CH3** | Combined Static Baseline | CH1 + CH3 | 2019 | 2.02 | - | - | Reference |

**Important Note on Table Interpretation:** 
- **Bold values** indicate the best result in each column.
- **Rel. to Best Panel**: percentage gain/loss relative to the best-performing channel (CH4, marked **Reference**). Negative values indicate how much less energy a channel produces compared to CH4. E.g. CH2 = 2136 Wh vs. CH4 = 2394 Wh → (2136 - 2394)/2394 = -10.8%
...
|---------|--------|-------|---------|---------|-------------|---------|--------------|
| **CH1** | West 30° (Static) | CHSM54M-HC-405 | 0.0 | 236.9 | 113.6 | 88.2 | 5167 |
| **CH2** | Sunchronizer S2 (1-Axis) | CHSM54M-HC-405 | 0.0 | 367.3 | 219.3 | 128.0 | 5966 |
| **CH3** | East 30° (Static) | JAM54S31-395 | 0.0 | 194.8 | 105.1 | 70.4 | 4704 |
| **CH4** | Sunchronizer D2 (2-Axis) | JAM54S31-395 | 0.0 | **344.2** | **242.7** | **109.2** | 6057 |

**Observations:**
- CH2 reaches higher peak power (367.3 W) than CH4 (344.2 W) because it has a higher-rated panel with lower losses at that specific moment
- However, CH4 maintains better average power (242.7 W vs. 219.3 W), demonstrating superior tracking throughout the day
...
- **CH1** (West 30°): **1116 Wh** (1.12 kWh)
- **CH2** (Elevation 1-Axis): **2136 Wh** (2.14 kWh)
- **CH3** (East 30°): **903 Wh** (0.90 kWh)
- **CH4** (2-Axis Sunchronizer): **2394 Wh** (2.39 kWh) ⭐
...
- vs. CH2 (1-Axis Elevation): **+12.1%** more energy
- vs. CH1 (West Static): **+114.5%** more energy (2.1× higher)
- vs. CH3 (East Static): **+165.1%** more energy (2.7× higher)

**Practical significance:** The 2-axis system produces at least 115% more energy than static systems and still beats the best alternative single-axis system by 12.1%.
...
- S2 mean ratio: **96.8%**
- S2 median ratio: **105.8%**
- D2 mean ratio: **130.2%**
- D2 median ratio: **109.4%**
- Samples used: **651**
...
- ✅ Peak power: 344.2 W (87.1% of panel rating)
- ✅ Average power: 242.7 W (61.4% of panel rating)
- ✅ Excellent performance even during marginal hours (early/late)
- ✅ Energy yield: 2394 Wh/day
...
**Performance Characteristics:**
- Peak power: 367.3 W (90.7% of panel rating) ← Higher peak than CH4
- Average power: 219.3 W (54.1% of panel rating)
- Energy yield: 2136 Wh/day
...
- ❌ Produces 12.1% less energy than 2-axis system

**Performance vs. CH4:** 12.1% less yield

### Static Systems (CH1 West & CH3 East)

**CH1 - West 30° Static - CHSM54M-HC-405 (405W):**
- Peak: 236.9 W (58.5% of panel rating)
- Average: 113.6 W (28.1% of panel rating)
- Yield: 1116 Wh/day
- Only produces power during afternoon (west-facing)

**CH3 - East 30° Static - JAM54S31-395 (395W):**
- Peak: 194.8 W (49.3% of panel rating)
- Average: 105.1 W (26.6% of panel rating)
- Yield: 903 Wh/day
...
**Performance vs. CH4:**
- CH1 (West): 114.5% less yield
- CH3 (East): 165.1% less yield
...
3. The momentary peak of 367.3W in CH2 occurs at a specific instant when:
...
6. **CH4, despite not reaching as high a peak, sustains higher power longer**, resulting in **12.1% more total daily energy**
...
|--------|--------|-------|-----------|
| Peak Power | CH2 | 367.3 W | +6.7% |
| Average Power | CH4 | 242.7 W | +10.7% |
| Daily Yield | CH4 | 2394 Wh | +12.1% |
...
- **Dual-axis setup (2 × CH4-equivalent):** 4788 Wh/day
- **Static east/west setup (CH1 + CH3):** 2019 Wh/day
- **Daily additional yield:** **2.77 kWh/day**
- **Annual additional yield (250 sunny days):** **692.2 kWh/year**
- **At €0.25/kWh:** **€173.06 additional revenue/year**

**ROI Estimation:**
- Estimated tracker system cost (Sunchronizer D2 mechanisms): **€200**
- Annual energy advantage at €0.25/kWh: €173.06
- Simple payback period: **1.2 years**
- **Annual return on investment:** 87% (based on €200 tracker cost)
...
**Environmental Conditions:**
- Temperature: 4.3°C - 17.0°C (ideal for silicon panels)
