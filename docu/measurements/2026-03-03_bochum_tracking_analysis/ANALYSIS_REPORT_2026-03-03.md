...
**Recording Duration:** 13.2 hours (05:40 UTC to 17:42 UTC)  
**Outside Temperature:** 6.1°C to 16.6°C (Average: 12.1°C)
...
|---------|--------|-------|------------|------------|---------------------|---------------------|----------------------------------|
| **CH1** | West 30° (Static) | CHSM54M-HC-405 | 1059 | 1.06 | -54.2% | +24.3% | -44.6% |
| **CH2** | Sunchronizer S2 (1-Axis) | CHSM54M-HC-405 | 2073 | 2.07 | -10.3% | +143.3% | +8.5% |
| **CH3** | East 30° (Static) | JAM54S31-395 | 852 | 0.85 | -63.1% | Reference | -55.4% |
| **CH4** | Sunchronizer D2 (2-Axis) | JAM54S31-395 | **2310** | **2.31** | **Reference** | **+171.1%** | **+20.9%** |
| **CH1+CH3** | Combined Static Baseline | CH1 + CH3 | 1911 | 1.91 | - | - | Reference |

**Important Note on Table Interpretation:** 
- **Bold values** indicate the best result in each column.
- **Rel. to Best Panel**: percentage gain/loss relative to the best-performing channel (CH4, marked **Reference**). Negative values indicate how much less energy a channel produces compared to CH4. E.g. CH2 = 2073 Wh vs. CH4 = 2310 Wh → (2073 - 2310)/2310 = -10.3%
...
|---------|--------|-------|---------|---------|-------------|---------|--------------|
| **CH1** | West 30° (Static) | CHSM54M-HC-405 | 0.0 | 231.4 | 112.5 | 85.3 | 5064 |
| **CH2** | Sunchronizer S2 (1-Axis) | CHSM54M-HC-405 | 0.0 | 357.0 | 215.7 | 123.3 | 5670 |
| **CH3** | East 30° (Static) | JAM54S31-395 | 0.0 | 189.5 | 91.6 | 65.8 | 4158 |
| **CH4** | Sunchronizer D2 (2-Axis) | JAM54S31-395 | 0.0 | **333.6** | **233.9** | **107.5** | 5635 |

**Observations:**
- CH2 reaches higher peak power (357.0 W) than CH4 (333.6 W) because it has a higher-rated panel with lower losses at that specific moment
- However, CH4 maintains better average power (233.9 W vs. 215.7 W), demonstrating superior tracking throughout the day
...
- **CH1** (West 30°): **1059 Wh** (1.06 kWh)
- **CH2** (Elevation 1-Axis): **2073 Wh** (2.07 kWh)
- **CH3** (East 30°): **852 Wh** (0.85 kWh)
- **CH4** (2-Axis Sunchronizer): **2310 Wh** (2.31 kWh) ⭐
...
- vs. CH2 (1-Axis Elevation): **+11.4%** more energy
- vs. CH1 (West Static): **+118.1%** more energy (2.2× higher)
- vs. CH3 (East Static): **+171.1%** more energy (2.7× higher)

**Practical significance:** The 2-axis system produces at least 118% more energy than static systems and still beats the best alternative single-axis system by 11.4%.
...
|--------|---------------------|-------------------|
| Mean error | 20.99° | 6.25° |
| Median error | 19.40° | 1.56° |
| 95th percentile | 37.27° | 76.10° |
| Daylight samples | 65488 | 65488 |
| Evaluation window (UTC) | 06:13-17:13 | 06:13-17:13 |
...
- ✅ Peak power: 333.6 W (84.5% of panel rating)
- ✅ Average power: 233.9 W (59.2% of panel rating)
- ✅ Excellent performance even during marginal hours (early/late)
- ✅ Energy yield: 2310 Wh/day
...
**Performance Characteristics:**
- Peak power: 357.0 W (88.1% of panel rating) ← Higher peak than CH4
- Average power: 215.7 W (53.3% of panel rating)
- Energy yield: 2073 Wh/day
...
- ❌ Produces 11.4% less energy than 2-axis system

**Performance vs. CH4:** 11.4% less yield

### Static Systems (CH1 West & CH3 East)

**CH1 - West 30° Static - CHSM54M-HC-405 (405W):**
- Peak: 231.4 W (57.1% of panel rating)
- Average: 112.5 W (27.8% of panel rating)
- Yield: 1059 Wh/day
- Only produces power during afternoon (west-facing)

**CH3 - East 30° Static - JAM54S31-395 (395W):**
- Peak: 189.5 W (48.0% of panel rating)
- Average: 91.6 W (23.2% of panel rating)
- Yield: 852 Wh/day
...
**Performance vs. CH4:**
- CH1 (West): 118.1% less yield
- CH3 (East): 171.1% less yield
...
3. The momentary peak of 357.0W in CH2 occurs at a specific instant when:
...
6. **CH4, despite not reaching as high a peak, sustains higher power longer**, resulting in **11.4% more total daily energy**
...
|--------|--------|-------|-----------|
| Peak Power | CH2 | 357.0 W | +7.0% |
| Average Power | CH4 | 233.9 W | +8.4% |
| Daily Yield | CH4 | 2310 Wh | +11.4% |
...
- **Dual-axis setup (2 × CH4-equivalent):** 4620 Wh/day
- **Static east/west setup (CH1 + CH3):** 1911 Wh/day
- **Daily additional yield:** **2.71 kWh/day**
- **Annual additional yield (250 sunny days):** **677.2 kWh/year**
- **At €0.25/kWh:** **€169.31 additional revenue/year**

**ROI Estimation:**
- Estimated tracker system cost (Sunchronizer D2 mechanisms): **€200**
- Annual energy advantage at €0.25/kWh: €169.31
- Simple payback period: **1.2 years**
- **Annual return on investment:** 85% (based on €200 tracker cost)
...
**Environmental Conditions:**
- Temperature: 6.1°C - 16.6°C (ideal for silicon panels)
