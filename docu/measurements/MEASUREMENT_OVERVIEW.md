...
| Apr 30 | Clear Sky | 14.1h | 15.1°C | 2,308 | 2,825 | 2,032 | **3,237** | 229.6 W | ~18.0° | ~1.6° | [Link](2026-04-30_bochum_tracking_analysis/ANALYSIS_REPORT_2026-04-30.md) |
| **Avg** | - | **13.7h** | **12.5°C** | **1,386** | **2,308** | **1,189** | **2,827** | **248.0 W** | **18.41°** | **1.58°** | - |

### Performance Summary

**Sunchronizer D2 (CH4) Advantages:**
- **vs. Static East/West:** +137.5% average daily energy (2,827 Wh vs. avg 1,188 Wh)
- **vs. Single-Axis S2:** +22.5% average daily energy (2,827 Wh vs. 2,308 Wh)
- Average daily yield: **2.83 kWh** (range: 2.31-3.24 kWh)
