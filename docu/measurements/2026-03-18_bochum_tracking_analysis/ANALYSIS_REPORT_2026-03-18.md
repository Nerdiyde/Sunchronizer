...
|---------|--------|-------|------------|------------|------------------|
| **CH1** | West 30° (Static) | CHSM54M-HC-405 | 1368 | 1.37 | -99.6% |
| **CH2** | Sunchronizer S2 (1-Axis) | CHSM54M-HC-405 | 2324 | 2.32 | **-17.5%** |
| **CH3** | East 30° (Static) | JAM54S31-395 | 1194 | 1.19 | -128.7% |
| **CH4** | Sunchronizer D2 (2-Axis) | JAM54S31-395 | **2731** | **2.73** | **Reference** |
...
- CH2 produces 17.5% LESS than CH4, not more.
- For example: CH2 = 2324 Wh vs. CH4 = 2731 Wh → Difference = (2324 - 2731)/2324 = -17.5%
...
**Practical significance:** The 2-axis system produces roughly 100-129% more energy than static systems and still beats the best alternative single-axis system by 17.5%.
...
- Average: 134.9 W (34.2% of panel rating)
- Yield: 1194 Wh/day
